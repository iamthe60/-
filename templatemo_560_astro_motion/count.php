...
$find = "SELECT area from item where name = '$itemname';";
...
if(isset($_POST['confirm'])){   
    $query = "SELECT amount from item where name = '$itemname';";
    $result = mysqli_query($conn,$query);
    $row = mysqli_fetch_assoc($result);
    $value = $row['amount']-1;
   
    $updateUser = "UPDATE item SET `amount`='$value' WHERE `name`='$itemname';";
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid tm-content-container">
                <div style=" padding-left: 10%;">
                    <h1>您選擇了 <?php echo $itemname; ?>，是否確認購買？</h1>
                    <form method="post">
